...
function Hero() {
  return (
    <div className='flex flex-col justify-center items-center my-20'>
        ...
        <h2 className='text-xl mt-5 text-slate-500'>OCTA is your scheduling automation platform for eliminating the back-and-forth emails to find the perfect time — and so much more.</h2>
        <div className='flex gap-4 flex-col mt-5'>
            <h3 className='text-sm'>Sign Up free with Google and Apple</h3>
            <div className='flex justify-center gap-8'>
               <LoginLink> <Button className="p-7 flex gap-4">
                    ...
                    <LoginLink>  <Button className="p-7 flex gap-4">
                    <Image src='/Apple.png' alt='google'
                    width={40} height={40}/>
                    Sign up with Apple</Button></LoginLink>
            </div>
            <hr></hr>
